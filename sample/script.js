...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const formDataArray = []; // Array to hold submitted form data
  ...
  form.addEventListener("submit", (event) => {
    ...
    // Log the form data array (for now, for testing)
    console.log("Form Data Array:", formDataArray);

    // Display the form data below the form in a line-by-line format
    const displaySection = document.getElementById("form-data-display");

    // Make the section visible
    displaySection.style.display = "block"; // Show the data section

    // Fill the display fields with the submitted data
